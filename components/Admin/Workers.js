  ...
  return (
    <div className="w-9/12 p-7">
      ...
      <div className="grid grid-cols-3 gap-5">
        <Link href="workers/administration/all_administrators">
          <div className="bg-green-100 rounded-xl p-3 cursor-pointer">
            ...
            <p className="text-green-900 ">Administration Staff</p>
          </div>
        </Link>
        ...
        <Link href="workers/nonTeaching/allNonTeaching">
          <div className="bg-yellow-100  cursor-pointer rounded-xl p-3">
            <div className="flex justify-between items-center  text-yellow-900">
              <UserGroupIcon className="h-10" />
            </div>
            <p className=" text-yellow-900 text-2xl font-bold">10</p>
